...
import pomodoro_display

if typing.TYPE_CHECKING:
    import sphinx.application


project = "pomodoro-display"
author = "Anton Lu"
version = pomodoro_display.__version__
...
def hijack_module_name_replacement() -> None:
    ...
    import pomodoro_display._mod_replace

    for mod_name in list(sys.modules):
        if mod_name == "pomodoro_display._mod_replace":
            continue
        if mod_name == "pomodoro_display" or mod_name.startswith("pomodoro_display."):
            del sys.modules[mod_name]

    pomodoro_display._mod_replace.replace_modname = lambda *_: None  # noqa: SLF001
